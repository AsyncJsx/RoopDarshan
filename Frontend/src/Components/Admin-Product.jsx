...
function Admin_Product({ product }) {
  ...
  return (
    ...
    >
      ...
      <div className="w-full h-32 sm:h-40 md:h-60 overflow-hidden rounded-md relative border border-gray-100 ">
        ...
        <img
          src={
            "https://res.cloudinary.com/dm1lsindg/image/upload/v1767778918/logo-black_sv2suh.png"
          }
          alt="logo watermark"
  ...
  `}
      ...
      <div className=" w-full h-8 flex items-center justify-end gap-3 ">
        <Link
          ...
          class="ri-edit-2-line text-green-500 text-xl hover:text-green-700 hover:underline underline-offset-4"
        ></Link>
        <Link
          to={`/product/delete/${product._id}`}
          class="ri-delete-bin-line text-red-500 text-xl hover:text-red-700 hover:underline underline-offset-4"
        ></Link>
      </div>
    </Link>
  );
